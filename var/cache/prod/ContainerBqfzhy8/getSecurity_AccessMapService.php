...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/publickey/get'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/[0-9]+/job/[0-9]+/run'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/params'), [0 => 'ROLE_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/repositorybackupscript'), [0 => 'ROLE_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/publickey/generate'), [0 => 'ROLE_ADMIN'], NULL);
