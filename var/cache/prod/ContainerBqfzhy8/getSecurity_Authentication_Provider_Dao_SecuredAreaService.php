...
return $this->services['security.authentication.provider.dao.secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.administrators']) ? $this->services['security.user.provider.concrete.administrators'] : $this->load('getSecurity_User_Provider_Concrete_AdministratorsService.php')) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', ${($_ = isset($this->services['security.encoder_factory']) ? $this->services['security.encoder_factory'] : $this->load('getSecurity_EncoderFactoryService.php')) && false ?: '_'}, true);
