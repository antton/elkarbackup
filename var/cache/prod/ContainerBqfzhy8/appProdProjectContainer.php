...
class appProdProjectContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['BnvTwigDebug']) ? $this->services['BnvTwigDebug'] : ($this->services['BnvTwigDebug'] = new \Twig_Extension_Debug())) && false ?: '_'});
    ...
    {
        return $this->services['BnvTwigDebug'] = new \Twig_Extension_Debug();
    }
     ...
     *
     * @return \JMS\SecurityExtraBundle\Security\Authorization\RememberingAccessDecisionManager
     */
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->services['security.access.decision_manager'] = new \JMS\SecurityExtraBundle\Security\Authorization\RememberingAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jms_di_extra.doctrine_integration.entity_manager.file': $value = ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5dd2a89fda2ff.php'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'assetic.bundles' => [
                ...
                11 => 'BinovoElkarBackupBundle',
                12 => 'BinovoElkarTahoeBundle',
                13 => 'KnpMenuBundle',
                14 => 'KnpPaginatorBundle',
                15 => 'DoctrineMigrationsBundle',
                16 => 'FOSRestBundle',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5dd2a89fda2ff_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
