...
return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'db', 'port' => 3306, 'dbname' => 'elkarbackup34', 'user' => 'root', 'password' => 'your-password-here', 'charset' => 'UTF8', 'driverOptions' => [], 'serverVersion' => 5.5, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, []);
