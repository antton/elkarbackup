...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/Binovo/ElkarBackupBundle/Entity')]), 'Binovo\\ElkarBackupBundle\\Entity');

$a->setEntityNamespaces(['BinovoElkarBackupBundle' => 'Binovo\\ElkarBackupBundle\\Entity']);
