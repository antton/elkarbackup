...
// Returns the private 'BnvWebLoggerFormatter' shared service.
...
return $this->services['BnvWebLoggerFormatter'] = new \Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context% %extra.user_name% %extra.user_email%'."\n".'');
