...
class __TwigTemplate_473ba5a831996dfa7f7fa23bac247a3dc80938f294e88a1187933036bad7e70e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <div id=\"";
            ...
            ";
                // line 247
                echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 247, $this->source); })()), "context", [], "any", false, false, false, 247), 1]);
                echo "
        </div>
        ...
        ";
                ...
                ";
                    // line 252
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 252, $this->source); })()), "context", [], "any", false, false, false, 252), "exception", [], "any", false, false, false, 252), "trace", [], "any", false, false, false, 252), 1]);
                    echo "
            </div>
        ";
                }
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/app/elkarbackup/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
