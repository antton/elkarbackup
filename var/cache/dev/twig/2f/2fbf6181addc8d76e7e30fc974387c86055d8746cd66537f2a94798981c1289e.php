...
class __TwigTemplate_8f7b3b93055880ff76b72aca11ca1b83f8b62d2b160d734bbfbe135c8085c08d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["key"] == "hit_read_ratio")) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                        ...
                        echo "()</td>
                                        <td>";
                        // line 142
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["call"], "value", [], "any", false, false, false, 142), "result", [], "any", false, false, false, 142), 2]);
                        echo "</td>
                                    </tr>
                                ";
                        ++$context['loop']['index0'];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/app/elkarbackup/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/cache.html.twig");
    }
}
