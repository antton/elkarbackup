...
class __TwigTemplate_9d4c0b9a26efe4145b6a3101fa50da22cb31a193058357bb69e4e45ea1c25e9b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
            ...
            echo "\">
                ";
            // line 67
            echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, $context["call"], "context", [], "any", false, false, false, 67), 1]);
            echo "
            </div>
            ...
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["call"], "violations", [], "any", false, false, false, 70))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["violation"]) {
                    ...
                    echo "</td>
                            <td>";
                    // line 84
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, $context["violation"], "seek", [0 => "invalidValue"], "method", false, false, false, 84)]);
                    echo "</td>
                            <td>";
                    // line 85
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/app/elkarbackup/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/validator.html.twig");
    }
}
