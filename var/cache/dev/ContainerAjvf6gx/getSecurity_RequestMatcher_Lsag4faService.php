...
// Returns the private 'security.request_matcher.lsag4fa' shared service.
...
return $this->services['security.request_matcher.lsag4fa'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js|setlocale)/');
